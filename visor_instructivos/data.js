// Base de datos estática generada para el Visor de Instructivos Ellucian
var APP_TREE = window.APP_TREE = {
  "name": "ellucian - instructivos",
  "type": "directory",
  "path": ".",
  "children": [
    {
    ...
    },
    {
      ...
      "children": [
        ...
        {
          "name": "3.2 Gest de Decisiones de Admi de Estud",
          "type": "directory",
          ...
          "children": [
            ...
            {
              "name": "3.2.3 Procedimiento Validar los documentos suplementarios.pptx",
              "type": "file",
              "path": "CAPACIDAD 3/3.2 Gest de Decisiones de Admi de Estud/3.2.3 Procedimiento Validar los documentos suplementarios.pptx",
              "id": "3.2.3_Procedimiento_Validar_los_documentos_suplementarios",
              "size": "2.73 MB",
              "sizeBytes": 2867752
            },
            {
            ...
            {
              "name": "3.2.7 Procedimiento Gestionar Reingresos.pptx",
              "type": "file",
              "path": "CAPACIDAD 3/3.2 Gest de Decisiones de Admi de Estud/3.2.7 Procedimiento Gestionar Reingresos.pptx",
              "id": "3.2.7_Procedimiento_Gestionar_Reingresos",
              "size": "6.44 MB",
              "sizeBytes": 6752863
            }
          ],
        ...
        {
          "name": "3.3 Articulac de Transfere de Estud",
          "type": "directory",
    ...
    },
    {
      ...
      "children": [
        ...
        {
          "name": "8.3 Actividades Cocurriculares",
          "type": "directory",
    ...
    },
    {
      ...
      "children": [
        {
          "name": "10.1 Accesibilidad para Estudiantes",
          "type": "directory",
    ...
    },
    {
      ...
      "children": [
        {
          "name": "11.1 Cuentas por Cobrar del Estudiante",
          "type": "directory",
          "path": "CAPACIDAD 11/11.1 Cuentas por Cobrar del Estudiante",
          "children": [
            {
              "name": "11.1.1 - Gest. Config Cuenta Corriente.pptx",
              "type": "file",
              "path": "CAPACIDAD 11/11.1 Cuentas por Cobrar del Estudiante/11.1.1 - Gest. Config Cuenta Corriente.pptx",
              "id": "11.1.1_-_Gest._Config_Cuenta_Corriente",
              "size": "8.33 MB",
              "sizeBytes": 8737037
            },
            {
              "name": "11.1.2 -  Gestionar los beneficios.pptx",
              "type": "file",
              "path": "CAPACIDAD 11/11.1 Cuentas por Cobrar del Estudiante/11.1.2 -  Gestionar los beneficios.pptx",
              "id": "11.1.2_-__Gestionar_los_beneficios",
              "size": "14.89 MB",
              "sizeBytes": 15611334
            },
            {
              "name": "11.1.3 - Gestionar los planes de pago.pptx",
              "type": "file",
              "path": "CAPACIDAD 11/11.1 Cuentas por Cobrar del Estudiante/11.1.3 - Gestionar los planes de pago.pptx",
              "id": "11.1.3_-_Gestionar_los_planes_de_pago",
              "size": "8.60 MB",
              "sizeBytes": 9019562
            }
          ],
...
var PRESENTATIONS = window.PRESENTATIONS = {
  "1.1.1_Definir_la_estructura_de_los_periodos_acade_micos": {
    ...
    "forms": [
      ...
      "STVACYR (Años académicos)",
      "STVTRMT (Tipos de periodo)",
      "STVTERM (Periodos académicos)"
    ],
    "purpose": "Crear y parametrizar las unidades de tiempo institucional (años, tipos de periodos, partes de periodo y periodos académicos base) para activar/desactivar actividades académicas y administrativas.",
    "rules": [
      "Debe existir obligatoriamente la parte de periodo 1 (Periodo Completo) en STVPTRM.",
      "En STVACYR, los años 0000 y 9999 son mandatorios con el checkbox de sistema marcado.",
      "En STVTERM, las fechas de alojamiento y año de ayuda financiera son requeridos obligatoriamente por el sistema aunque no se usen dichos módulos."
    ]
  },
  "1.1.2_Programar_el_inicio_y_finalizacio_n_de_per_acad": {
    ...
    "forms": [
      ...
      "SSAEXCL (Días festivos y exclusiones)"
    ],
    "purpose": "Habilitar operativamente el periodo lectivo en Banner, activar controles de web, definir partes de periodo con sus fechas límites y configurar exclusiones/festivos.",
    "rules": [
      "Se debe indicar el número 10000 como número de inicio de CRN en SOATERM.",
      "Activar propiedad Plan de estudios requerido para validar matrículas contra el plan.",
      "Activar Control de periodo en web maestro para habilitar visualización docente en Autoservicio.",
      "Para periodos antiguos, desactivar la propiedad de control web."
    ]
  },
  "1.1.3_Disen_ar_y_crear_los_programas_acade": {
    ...
    "forms": [
      "SMAPRLE (Programas)",
      "STVMAJR (Carreras y Menciones)",
      "SOACURR (Reglas de Currícula Base)",
      "STVCAMP",
      "STVCOLL",
      "STVDEGC",
      "STVDEPT",
    ...
    "purpose": "Estructurar programas de estudio, niveles, escuelas, títulos, carreras/majors, menciones/concentraciones y vincularlos a través de reglas curriculares base.",
    "rules": [
      "Cada programa debe tener una regla curricular base configurada en SOACURR.",
      "En SOACURR se activan los módulos específicos (Admisión, Registro, Graduación).",
      "Si el programa tiene menciones, se crean en STVMAJR y se enlazan en la pestaña de detalles de concentración."
    ]
  },
  "1.1.4_Disen_ar_y_crear_los_cursos": {
    ...
    "forms": [
      ...
      "STVSUBJ (Materias)",
      "STVCSTA (Estatus)",
      "STVGMOD (Modos de calificar)",
      "STVSCHD (Tipos de horario)",
      "GTVINSM (Método educativo)"
    ],
    "purpose": "Crear y mantener el catálogo de asignaturas institucionales con sus créditos académicos, créditos de cobro, horas lectivas, niveles y métodos de enseñanza.",
    "rules": [
      "Se requiere un código de Materia (STVSUBJ) de hasta 4 caracteres.",
      "Debe existir exactamente un modo de calificación marcado como predeterminado en SCACRSE.",
      "Se definen por separado los créditos académicos (historia y promedio) y créditos de cobro (facturación).",
      "Dispone de función Copiar para duplicar asignaturas entre periodos o cursos similares."
    ]
  },
  "1.1.5_Asignar_prerequ__corequis_y_restricci": {
    "id": "1.1.5_Asignar_prerequ__corequis_y_restricci",
    "name": "1.1.5 Asignar prerequ, corequis y restricci.pptx",
    ...
    "forms": [
      ...
      "SCADETL (Correquisitos)",
      "SCARRES (Restricciones)",
      "SCAMEXC (Exclusiones mutuas)"
    ],
    "purpose": "Establecer condiciones obligatorias de inscripción: asignaturas previas requeridas con nota mínima, cursos simultáneos obligatorios y filtros por atributos de alumno.",
    "rules": [
      "SCAPREQ permite lógica booleana AND / OR y evaluación de exámenes de ubicación (STVTESC).",
      "SCADETL exige inscripción simultánea en el mismo intento de matrícula (ej. Teoría y Lab).",
      "SCARRES admite reglas de Inclusión o Exclusión por nivel, grado, programa, campus, escuela, atributo o cohorte."
    ]
  },
  "1.2.1_Crear_las_mallas_curriculares": {
    "id": "1.2.1_Crear_las_mallas_curriculares",
    "name": "1.2.1 Crear las mallas curriculares.pptx",
    ...
    "forms": [
      ...
      "SMAAREA (Requerimientos de área)",
      "SMAPROG (Requerimientos de programa)"
    ],
    "purpose": "Diseñar la estructura curricular para el motor de auditoría y avance CAPP: Programa -> Áreas -> Reglas -> Cursos/Condiciones.",
    "rules": [
      "En SMAALIB se marca el flag Cumplimiento para que CAPP pueda evaluar el área.",
      "Permite modelar áreas dinámicas según características del estudiante (ej. concentración elegida).",
      "En SMAPROG se definen créditos totales mínimos del grado, créditos de residencia y GPA mínimo."
    ]
  },
  "1.2.2_Crear_las_mallas_curric-Atri_de_curso": {
    "id": "1.2.2_Crear_las_mallas_curric-Atri_de_curso",
    "name": "1.2.2 Crear las mallas curric-Atri de curso.pptx",
    ...
    "forms": [
      ...
      "SCADETL (Atributos de grado)",
      "SMAAREA (Reglas con atributos)"
    ],
    "purpose": "Modelar cursos electivos y optativos de forma desacoplada y eficiente usando atributos evaluados por CAPP sin listas fijas de cursos.",
    "rules": [
      "Se crea el atributo en STVATTR y se vincula a las asignaturas electivas en SCADETL.",
      "En SMAAREA se crea la regla especificando el Atributo de Curso y la cantidad de condiciones requeridas.",
      "El motor CAPP reconoce automáticamente cualquier curso aprobado que posea dicho atributo."
    ]
  },
  "1.2.3_Asignar_equivalencias": {
    "id": "1.2.3_Asignar_equivalencias",
    "name": "1.2.3 Asignar equivalencias.pptx",
    ...
    "forms": [
      ...
      "SMAAREA (Equivalencias por malla - Recomendado Ellucian)"
    ],
    "purpose": "Configurar qué asignaturas convalidan o equivalen a otras en la historia académica y progreso del plan de estudios.",
    "rules": [
      "Por curso en SCADETL: equivalencia 1 a 1 indicando periodo de inicio y fin de vigencia.",
      "Por malla curricular en SMAAREA (Recomendado): uso de conjuntos y subconjuntos.",
      "Subconjuntos IGUALES dentro del mismo conjunto = Y (AND).",
      "Subconjuntos DIFERENTES dentro del mismo conjunto = O (OR)."
    ]
  },
  "1.3.1_Actualizar_las_mallas_curriculares": {
    "id": "1.3.1_Actualizar_las_mallas_curriculares",
    "name": "1.3.1 Actualizar las mallas curriculares.pptx",
    ...
    "forms": [
      ...
      "SMAPROG (Copiar programa al nuevo periodo)",
      "SMAALIB (Nuevas áreas si aplica)"
    ],
    "purpose": "Versionar y modificar mallas curriculares ante reformas de planes de estudio usando períodos de catálogo para preservar las cohortes anteriores.",
    "rules": [
      "Se copian las áreas y programas hacia el nuevo periodo de catálogo en SMAAREA y SMAPROG.",
      "Se modifican o reemplazan las reglas y materias necesarias.",
      "Si la reforma introduce nuevos núcleos curriculares, se crean áreas adicionales en SMAALIB y se enlazan."
    ]
  },
  ...
  "10_4.2.4.3.5_Inst._Programar_Comunicaciones_Masivas": {
    "id": "10_4.2.4.3.5_Inst._Programar_Comunicaciones_Masivas",
    "name": "10_4.2.4.3.5 Inst. Programar Comunicaciones Masivas.pptx",
  ...
  "11.1.1_-_Gest._Config_Cuenta_Corriente": {
    "id": "11.1.1_-_Gest._Config_Cuenta_Corriente",
    "name": "11.1.1 - Gest. Config Cuenta Corriente.pptx",
    "title": "11.1.1 - Gest. Config Cuenta Corriente",
    "path": "CAPACIDAD 11/11.1 Cuentas por Cobrar del Estudiante/11.1.1 - Gest. Config Cuenta Corriente.pptx",
    "size": "8.33 MB",
    "forms": [],
    "purpose": "Instructivo técnico oficial para 11.1.1 - Gest. Config Cuenta Corriente",
    "rules": []
  },
  "11.1.2_-__Gestionar_los_beneficios": {
    "id": "11.1.2_-__Gestionar_los_beneficios",
    "name": "11.1.2 -  Gestionar los beneficios.pptx",
    "title": "11.1.2 -  Gestionar los beneficios",
    "path": "CAPACIDAD 11/11.1 Cuentas por Cobrar del Estudiante/11.1.2 -  Gestionar los beneficios.pptx",
    "size": "14.89 MB",
    "forms": [],
    "purpose": "Instructivo técnico oficial para 11.1.2 -  Gestionar los beneficios",
    "rules": []
  },
  "11.1.3_-_Gestionar_los_planes_de_pago": {
    "id": "11.1.3_-_Gestionar_los_planes_de_pago",
    "name": "11.1.3 - Gestionar los planes de pago.pptx",
    "title": "11.1.3 - Gestionar los planes de pago",
    "path": "CAPACIDAD 11/11.1 Cuentas por Cobrar del Estudiante/11.1.3 - Gestionar los planes de pago.pptx",
    "size": "8.60 MB",
    "forms": [],
    "purpose": "Instructivo técnico oficial para 11.1.3 - Gestionar los planes de pago",
    "rules": []
  },
  ...
  "11.2.3__Gestionar_los_documentos_de_venta": {
    "id": "11.2.3__Gestionar_los_documentos_de_venta",
    "name": "11.2.3  Gestionar los documentos de venta.pptx",
  ...
  "11.3.1_Gestionar_la_cuenta_corriente": {
    "id": "11.3.1_Gestionar_la_cuenta_corriente",
    "name": "11.3.1 Gestionar la cuenta corriente.pptx",
  ...
  "3.2.3_Procedimiento_Validar_los_documentos_suplementarios": {
    "id": "3.2.3_Procedimiento_Validar_los_documentos_suplementarios",
    "name": "3.2.3 Procedimiento Validar los documentos suplementarios.pptx",
    "title": "3.2.3 Procedimiento Validar los documentos suplementarios",
    "path": "CAPACIDAD 3/3.2 Gest de Decisiones de Admi de Estud/3.2.3 Procedimiento Validar los documentos suplementarios.pptx",
    "size": "2.73 MB",
    "forms": [],
    "purpose": "Instructivo técnico oficial para 3.2.3 Procedimiento Validar los documentos suplementarios",
    "rules": []
  },
  ...
  "3.2.7_Procedimiento_Gestionar_Reingresos": {
    "id": "3.2.7_Procedimiento_Gestionar_Reingresos",
    "name": "3.2.7 Procedimiento Gestionar Reingresos.pptx",
    "title": "3.2.7 Procedimiento Gestionar Reingresos",
    "path": "CAPACIDAD 3/3.2 Gest de Decisiones de Admi de Estud/3.2.7 Procedimiento Gestionar Reingresos.pptx",
    "size": "6.44 MB",
    "forms": [],
    "purpose": "Instructivo técnico oficial para 3.2.7 Procedimiento Gestionar Reingresos",
    "rules": []
  },
  ...
  "4.3.1_Configuracion_de_Solicitudes_de_Servicio": {
    "id": "4.3.1_Configuracion_de_Solicitudes_de_Servicio",
    "name": "4.3.1 Configuracion de Solicitudes de Servicio.pptx",
  ...
  "4.3.2_Gestionar_las_solicitudes_de_servicios": {
    "id": "4.3.2_Gestionar_las_solicitudes_de_servicios",
    "name": "4.3.2 Gestionar las solicitudes de servicios.pptx",
  ...
  "5.1.1_Instructivo_-_Gestionar_persona_natural": {
    "id": "5.1.1_Instructivo_-_Gestionar_persona_natural",
    "name": "5.1.1 Instructivo - Gestionar persona natural.pptx",
  ...
  "5.1.1_Instructivo_-_Gestionar_persona_natural_V2": {
    "id": "5.1.1_Instructivo_-_Gestionar_persona_natural_V2",
    "name": "5.1.1 Instructivo - Gestionar persona natural_V2.pptx",
  ...
  "5.1.2_Instructivo_-_Gestionar_persona_juridica": {
    "id": "5.1.2_Instructivo_-_Gestionar_persona_juridica",
    "name": "5.1.2 Instructivo - Gestionar persona juridica.pptx",
  ...
  "5.2.1_Instructivo_-_Gestionar_retenciones_de_personas": {
    "id": "5.2.1_Instructivo_-_Gestionar_retenciones_de_personas",
    "name": "5.2.1 Instructivo - Gestionar retenciones de personas.pptx",
  ...
  "5.2.2_Instructivo_-_Asignar_o_actualizar_retenciones": {
    "id": "5.2.2_Instructivo_-_Asignar_o_actualizar_retenciones",
    "name": "5.2.2 Instructivo - Asignar o actualizar retenciones.pptx",
  ...
  "5.3_4.1.4.1.6_Instructivo_Registrar_la_oferta_horaria_de_los_cursos": {
    "id": "5.3_4.1.4.1.6_Instructivo_Registrar_la_oferta_horaria_de_los_cursos",
    "name": "5.3_4.1.4.1.6_Instructivo_Registrar la oferta horaria de los cursos.pptx",
  ...
  "5.3_4.1.4.1.8_Instructivo_Crear_Listas_Cruzadas": {
    "id": "5.3_4.1.4.1.8_Instructivo_Crear_Listas_Cruzadas",
    "name": "5.3_4.1.4.1.8_Instructivo_Crear Listas Cruzadas.pptx",
  ...
  "5.3_4.1.4.1.9_Instructivo_Crear_Ligas": {
    "id": "5.3_4.1.4.1.9_Instructivo_Crear_Ligas",
    "name": "5.3_4.1.4.1.9_Instructivo_Crear Ligas.pptx",
  ...
  "6.1.2_Asi_atribu_y_propie_especifi": {
    "id": "6.1.2_Asi_atribu_y_propie_especifi",
    "name": "6.1.2 Asi atribu y propie especifi.pptx",
  ...
  "7.1.1_Gestionar_la_asistencia_a_clases": {
    "id": "7.1.1_Gestionar_la_asistencia_a_clases",
    "name": "7.1.1 Gestionar la asistencia a clases.pptx",
  ...
  "7.1.2_Revisar_la_asistencia_a_clases": {
    "id": "7.1.2_Revisar_la_asistencia_a_clases",
    "name": "7.1.2 Revisar la asistencia a clases.pptx",
  ...
  "7.1.5_Revisar_las_calificaciones_por_autoser": {
    "id": "7.1.5_Revisar_las_calificaciones_por_autoser",
    "name": "7.1.5 Revisar las calificaciones por autoser.pptx",
  ...
  "7.1.6_Ingresar_calificac_backoffice": {
    "id": "7.1.6_Ingresar_calificac_backoffice",
    "name": "7.1.6 Ingresar calificac backoffice.pptx",
  ...
  "7.1.7_Gestionar_calificaciones_incompletas": {
    "id": "7.1.7_Gestionar_calificaciones_incompletas",
    "name": "7.1.7 Gestionar calificaciones incompletas.pptx",
  ...
  "7.1.8_Ges_ingreso_Cal_extraord_de_de_pasadas_a_HA": {
    "id": "7.1.8_Ges_ingreso_Cal_extraord_de_de_pasadas_a_HA",
    "name": "7.1.8 Ges ingreso Cal extraord de de pasadas a HA.pptx",
